...
<div class="b b-2">
	<div class="b-block clearfix">
		<div class="b-2-content">
			<h2><b>Скорая помощь </b> в «полевых условиях»!</h2>
	...
	<div class="b-block clearfix">
		...
		<div class="b-3-right">
			<form class="b-3-form">
				...
				<a href="#" class="b-btn-input">Перезвоните мне</a>
...
<div class="b b-reviews">
	...
	<div class="b-block">
		...
		<div class="center">
			<a href="#" class="b-btn-tr white">Смотреть все отзывы</a>
		</div>
	</div>
</div>
<div class="b-news">
		...
		<div class="b-news-list">
			...
			<a href="#" class="b-news-item">
				...
				<div class="b-news-item-content">
					...
					<p>Партия оригинальных гидроцилиндров DOOSAN на нашем складе</p>
				</div>
			</a>
			<a href="#" class="b-news-item">
				<div class="b-img-cont">
				...
				<div class="b-news-item-content">
					...
					<p>12 июня – День России! График работы.</p>
				</div>
			</a>
		</div>
