...
<div class="b-content b-content-inner">
	<div class="b-block">
		<ul class="b-breadcrumbs">
			...
			<li><a href="#">Двигатель Perkins RJ 81376U e2</a></li>
		</ul>
		<h1>Компрессор одноцилиндровый 011300457000</h1>
		<div class="b-spares-detail clearfix">
			<div class="b-spares-detail-left">
				<img src="i/spares-detail-main.jpg">
			</div>
			<div class="b-spares-detail-right">
				...
				<a href="#" class="b-btn-orange"><span>Заказать</span></a>
				<div class="detail-adv-list">
					<div class="detail-adv-item">
						<div class="b-img" style="background-image: url(i/spares-detail-1.svg);"></div>
						<div class="detail-adv-item-text">Гарантийное и сервисное обслуживание</div>
					</div>
					<div class="detail-adv-item">
					...
					<div class="detail-adv-item">
						...
						<div class="detail-adv-item-text">Индивидуальный подход к клиенту</div>
					</div>
				</div>
			</div>
		</div>
		<div class="b-spares-other">
			<h2>Другие запчасти для двигателя Mercedes-Benz ОМ457LA</h2>
			<div class="b-spares-list">
			...
			<div class="center">
				<a href="spares-list.php" class="b-btn-tr">Смотреть все запчасти</a>
			</div>
		</div>
	</div>
</div>
